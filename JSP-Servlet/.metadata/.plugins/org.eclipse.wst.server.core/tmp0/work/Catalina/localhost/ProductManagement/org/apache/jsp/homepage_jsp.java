 ...
 * Generated at: 2020-08-05 02:16:32 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\twebsite phù hợp với hành vi của người dùng và khả năng của màn hình\r\n");
      out.write("\t\t\t\t\thiển thị. Nếu cho rằng cần tạo một phiên bản “mobile” cho website\r\n");
      out.write("\t\t\t\t\tcủa mình, bạn hãy nghĩ lại. Thiết kế web thích ứng cung cấp một bản\r\n");
      out.write("\t\t\t\t\tthiết kế có khả năng làm việc tốt với desktop, smartphone và nhiều\r\n");
      out.write("\t\t\t\t\tthiết bị khác. HTML5, cũng như CSS3 vẫn đang tiếp tục hoàn thiện và\r\n");
      out.write("\t\t\t\t\tcuốn sách này sẽ giúp bạn nắm được những khái niệm nền tảng về cách\r\n");
      out.write("\t\t\t\t\ttổ chức, sáng tạo và phân phối nội dung web một cách hiệu quả thông\r\n");
      out.write("\t\t\t\t\tqua những phương pháp tối ưu nhất.Cuốn sách này gồm 15 bài học,\r\n");
      out.write("\t\t\t\t\tgiúp bạn tìm hiểu các kiến thức HTM5 và CSS3 cơ bản và nâng cao để\r\n");
      out.write("\t\t\t\t\ttạo các trang web thích ứng một cách hiệu quả. Các hướng dẫn từng\r\n");
      out.write("\t\t\t\t\tbước được trợ giúp với video và mã nguồn thực hành từ gói tài\r\n");
      out.write("\t\t\t\t\tnguyên kèm theo sách. Qua các bài học, bạn sẽ:- Học cách viết mã để\r\n");
      out.write("\t\t\t\t\ttạo các trang web với tính năng vượt trội, giàu khả năng thích ứng\r\n");
      out.write("\t\t\t\t\tnhờ các thẻ HTML5 mới- Xây dựng các form HTML5 và biết cách sử dụng\r\n");
      out.write("\t\t\t\t\tform trong thực tế- Thêm các nội dung đa phương tiện có tính linh\r\n");
      out.write("\t\t\t\t\thoạt cao mà không cần đến plug-in trình duyệt- Sử dụng phần tử\r\n");
      out.write("\t\t\t\t\tCanvas để tạo các hình với màu sắc, đường viền, hiệu ứng chuyển màu\r\n");
      out.write("\t\t\t\t\t…- Kết hợp việc định kiểu và các tính năng hoạt hình mạnh mẽ của\r\n");
      out.write("\t\t\t\t\tCSS3 để cải tiến trang web- Làm việc với các công nghệ hỗ trợ HTML5\r\n");
      out.write("\t\t\t\t\tđể xây dựng ứng dụng web dễ hơn bao giờ hết</p>\r\n");
      out.write("\r\n");
